...
const HeroActivityCard = ({
  ...
  return (
    <div className="w-full max-w-[800px] sm:max-w-[700px] lg:w-[500px]  bg-white rounded-2xl shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
        ...
        <div className="md:w-3/5 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-gray-100">
              <Button
                onClick={() => router.push("/fritidsaktiviteter")}
...
export default HeroActivityCard;
