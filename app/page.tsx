...
export default function Home() {
  return (
    <>
      ...
      {/* // Status section */}
      <div className="mx-auto max-w-7xl mt-12 flex justify-around items-center text-gray-400 ">
        <div className="flex flex-col items-center">
          <span className="md:text-6xl text-2xl font-bold">2,000+</span>
          <span className="text-start text-lg">People Helped Annually</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="md:text-6xl text-2xl font-bold">15+</span>
          <span className="text-start text-lg">Languages Spoken</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="md:text-6xl text-2xl font-bold">10+</span>
          <span className="text-start text-lg">Years of Experience</span>
        </div>
      </div>
    </>
  );
